        ...
        <div className="absolute flex justify-between md:flex-row flex-col w-[95%] sm:w-[80%] h-[95%] sm:h-[60%] wx-auto wy-auto b max-w-[1440px]">
            ...
            <form onSubmit={(e)=>handleSubmit(e)} className='w-full full my-auto flex items-center flex-col gap-10'>
                ...
                <div className="input-group w-full flex flex-col gap-3">
                    <p className="text-[17px] font-extrabold text-gray-500">ENTER OTP</p>
                    <span className="relative flex flex-row justify-between">
                        <input type="email" placeholder="Enter your otp here" className=" w-full h-[50px] focus:outline-none px-3 pr-[40px] border-2 rounded-[5px] border-slate-400 bg-transparent text-[16px] focus:bg-gray-100" />
                ...
                <CustomButton title="Verify Otp" btnType="submit" handleClick={handleSubmit} containerStyles="w-full text-[17px] rounded-[7px] bg-blue-600 hover:bg-blue-500 font-bold text-white " />
                
                <Link href="/login" className="w-full flex justify-center items-center">
                    <p className="text-[14px] text-blue-600 hover:text-blue-500 font-bold">Back to Login</p>
                </Link>
